        ...
        <div class="col-12 col-xl-12">
            ...
            <x-card class="shadow-sm overflow-hidden" bodyClass="text-bg-light shadow-sm p-4"
                ...
                <x-form url="{{ isset($barang_masuk) ? '/receiving/update' : '/receiving/store' }}"
                    ...
                    <x-horizontal-input name="no_warehouse" label="No.Warehouse"
                        value="{{ old('no_warehouse', $barang_masuk->no_warehouse ?? '') }}" />
                    ...
                    <div class="mb-3 row align-items-center">
                        <x-form-label for="sumber" value="Sumber Pembelian" class="col-xl-2 col-form-label form-label" />
                        <div class="col-xl-5">
                            @php
                    ...
                    <div class="mb-3 row align-items-center">
                        <x-form-label for="suppliers" value="Supplier" class="col-xl-2 col-form-label form-label" />
                        <div class="col-xl-5">
                            @php
                                $optionSupplier = [];
                    ...
                    <div class="mb-3 row align-items-center">
                        <x-form-label for="lokasi" value="Lokasi/Tempat" class="col-xl-2 col-form-label form-label" />
                        <div class="col-xl-5">
