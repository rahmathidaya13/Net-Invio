    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-form url="/receiving/pdf">
                    <div class="row g-0 mb-3">
                        <div class="col">
                            <x-form-label value="Tanggal Awal" for="tanggal_awal_pdf" />
                            <div class="input-group">
                                <x-form-input type="date" name="tanggal_awal_pdf" value="{{ old('tanggal_awal_pdf') }}" />
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                <x-form-input type="date" name="tanggal_akhir_pdf" value="{{ old('tanggal_akhir_pdf') }}" />
                                <x-base-button disabled type="submit" icon="fas fa-print" id="print_pdf" />
                            </div>
                        </div>
                    </div>
                </x-form>
                <x-link icon="fas fa-print" url="/receiving/pdf" label="Print All" class="btn btn-sm btn-primary" />
            </div>
        </div>
    </div>
</div>
