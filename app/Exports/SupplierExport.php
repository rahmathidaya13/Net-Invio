...
class SupplierExport implements FromView, WithHeadings, WithStyles, ShouldAutoSize
{
    /**
    ...
    {
        return view("Supplier.cetak.cetak_excel", ["supplier" => SupplierModel::all()]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A4:D4')->getAlignment()->setWrapText(true);
