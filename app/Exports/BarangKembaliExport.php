...
class BarangKembaliExport implements FromView, WithHeadings, WithStyles, ShouldAutoSize
{
    /**
    ...
    public function view(): View
    {
        if ($this->startDate && $this->endDate) {
            return view("BarangKembali.cetak.cetak_excel", ["barang_kembali" => ReturBarangModel::whereBetween('tanggal', [$this->startDate, $this->endDate])->get()]);
        } else {
            return view("BarangKembali.cetak.cetak_excel", ["barang_kembali" => ReturBarangModel::all()]);
        }
    }
