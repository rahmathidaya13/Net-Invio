...
class PelangganExport implements FromView, WithHeadings, WithStyles, ShouldAutoSize
{
    /**
    ...
    public function view(): View
    {
        if ($this->startDate && $this->endDate) {
            return view("Pelanggan.cetak.cetak_excel", ["pelanggan" => PelangganModel::whereBetween('tanggal', [$this->startDate, $this->endDate])->get()]);
        } else {
            return view("Pelanggan.cetak.cetak_excel", ["pelanggan" => PelangganModel::all()]);
        }
    }
